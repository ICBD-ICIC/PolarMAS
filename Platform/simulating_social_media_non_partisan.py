...
for filename in os.listdir('outputs/simulating_social_media_non_partisan/valid'):
...
for config_number in range(configs):
    ...
    platform = Platform(f'agents/simulating_social_media_non_partisan/agent_config_{config_number}.csv',
                        pre_questionnaire,
                        post_questionnaire,
                        experiment_description)

    platform.facilitate_discussion(total_messages)
    platform.save_run('outputs/simulating_social_media_non_partisan', f'agent_config_{config_number}')
